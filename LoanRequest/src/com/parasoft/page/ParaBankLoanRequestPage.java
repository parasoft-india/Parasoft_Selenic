...
public class ParaBankLoanRequestPage {
	...
	private WebElement applyNowSubmit;
	...
	public void setDownPaymentText(String text) {
		waitFor(downPaymentText).clear();
		downPaymentText.sendKeys(text);
	}

	public void clickApplyNowSubmit() {
		click(applyNowSubmit);
	}
